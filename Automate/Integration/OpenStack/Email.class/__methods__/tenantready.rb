...
subject = "Your OpenStack Tenant and User have been provisioned"

body = "Hello #{tenant_user},"

# Email body
body += "<br><br>Your request to provision a new OpenStack Tenant and User completed on #{Time.now.strftime('%A, %B %d, %Y at %I:%M%p')}. "
body += "<br><br>URL:&nbsp;&nbsp;<a href='#{tenant_url}'>#{tenant_url}</a>"
body += "<br><br>Tenant:&nbsp;'#{tenant_name}'"
body += "<br><br>User:&nbsp;'#{tenant_user}'"
body += "<br><br>Password:&nbsp;'#{tenant_password}'"
